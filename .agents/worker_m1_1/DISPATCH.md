...
- Target Report: /Users/sanjeev/Documents/project/globaleventstravel/.agents/worker_m1_1/changes.md
- Handoff Report: /Users/sanjeev/Documents/project/globaleventstravel/.agents/worker_m1_1/handoff.md
...
1. **Remove Featured Treks (R2)**:
   - In `frontend/src/pages/treks/index.astro`, remove the `TrekTrendingRow` import, remove the `featuredTreks` fetch call to `/api/v1/treks/featured`, and remove the Featured Treks section markup.
2. **Redesign Layout & Responsive Filters (R1)**:
   - Update `frontend/src/pages/treks/index.astro`:
     - Clean, modern Hero section.
     - Responsive Search & Filter bar (keyword search, location, difficulty, budget).
